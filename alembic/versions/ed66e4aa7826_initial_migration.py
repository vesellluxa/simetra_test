...
Revision ID: ed66e4aa7826
Revises:
Create Date: 2024-03-10 11:56:32.549164
...
def upgrade():
    ...
    sa.Column('geometry', geoalchemy2.types.Geometry(geometry_type='POINT', from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
...
def downgrade():
    ...
    op.drop_index('idx_track_geometry', table_name='track', postgresql_using='gist')
    op.drop_table('track')
